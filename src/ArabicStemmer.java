/**
 * ArabicStemmer.java
 * Purpose: The implementation of Khoja’s stemmer (http://zeus.cs.pacificu.edu/shereen/research.htm)
 */
...
public class ArabicStemmer{
    ...
    private static void initComponents()
    {
        ...
        possibleRoots = new String[100000][2];   //Me; I have add it
        wordNumber = 0;
        stopwordNumber = 0;
    ...
    {   
        ...
        {//Wojdan comment the following two lines
